            ...
            <div className="password">
                ...
                <label for="password" className="label">Password</label><br />
                    ...
                    <input
                        ...
                        name="password" 
                    />
                    <span className="password-logo" onClick={togglePasswordVisibility}>
                        {showPassword ? (
                            <svg width="15px" height="15px" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
